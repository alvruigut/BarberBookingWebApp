...
public class UsuarioAdministracion extends EntidadAuditable {
    ...
    public UsuarioAdministracion(Barberia b, Profesional p, String nombre, String hash, RolUsuario rol) {
        barberia = b;
        profesional = p;
    ...
    public void setNombreUsuario(String v) {
        nombreUsuario = v;
    }

    public void setContrasenaHash(String v) {
        contrasenaHash = v;
    }
    ...
    public void setFechaBloqueo(LocalDateTime v) {
        fechaBloqueo = v;
    }
}
